<?php
namespace Croco_MKI\Modules\Onboarding;
...
class Module extends Module_Base {
	...
	public function enqueue_module_assets() {
		...
		wp_enqueue_script(
			'croco-mki-onboarding',
			CROCO_MKI_URL . 'assets/js/onboarding.js',
			array( 'cx-vue-ui' ),
			CROCO_MKI_VERSION,
			true
		);
	...
	public function get_panels() {
		return apply_filters( 'croco-mki/onboarding/panels', array(
			array(
				...
				'title'      => __( 'Take a look at your site', 'croco-mki' ),
				'link'       => home_url( '/' ),
				'link_label' => __( 'Click here', 'croco-mki' ),
			),
			array(
				...
				'title'      => __( 'Proceed to editing pages', 'croco-mki' ),
			...
			array(
				...
				'title'      => __( 'Refer to Support for assistance', 'croco-mki' ),
			...
			array(
				...
				'title'      => __( 'Access the vast knowledge base', 'croco-mki' ),
			...
			array(
				...
				'title'      => __( 'Join community to stay tuned to the latest news', 'croco-mki' ),
			...
			array(
				...
				'title'      => __( 'Switch the current skin to another one', 'croco-mki' ),
