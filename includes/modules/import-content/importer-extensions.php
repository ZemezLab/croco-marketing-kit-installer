...
class Importer_Extensions {
	...
	public function __construct() {
		...
		add_filter( 'croco-mki/import/skip-post', array( $this, 'prevent_import_errors' ), 10, 2 );

		// Clear fonts cache after import
		add_action( 'croco-mki/import/finish', array( $this, 'clear_fonts_cache' ) );

		add_action( 'croco-mki/import/before-options-processing', array( $this, 'set_container_width' ) );
		add_action( 'croco-mki/import/after-options-processing', array( $this, 'set_required_options' ) );

		add_action( 'croco-mki/import/after-import-tables', array( $this, 'clear_woo_transients' ) );
