...
class Remap_Callbacks {
	...
	public function __construct( $importer ) {
		...
		add_action( 'croco-mki/import/remap-posts', array( $this, 'process_options' ) );
		add_action( 'croco-mki/import/remap-posts', array( $this, 'postprocess_posts' ) );
		add_action( 'croco-mki/import/remap-posts', array( $this, 'process_thumbs' ) );
		add_action( 'croco-mki/import/remap-posts', array( $this, 'process_elementor_pages_posts' ) );
		add_action( 'croco-mki/import/remap-posts', array( $this, 'process_home_page' ) );

		// Manipulations with terms remap array
		add_action( 'croco-mki/import/remap-terms', array( $this, 'process_term_parents' ) );
		add_action( 'croco-mki/import/remap-terms', array( $this, 'process_nav_menu' ) );
		add_action( 'croco-mki/import/remap-terms', array( $this, 'process_nav_menu_widgets' ) );
		add_action( 'croco-mki/import/remap-terms', array( $this, 'process_elementor_pages_terms' ) );
		add_action( 'croco-mki/import/remap-terms', array( $this, 'process_home_page' ) );
