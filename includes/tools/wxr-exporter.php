...
class WXR_Exporter {
	...
	public function get_options_to_export() {
		...
		if ( null === $this->export_options ) {
			...
			$default_options = apply_filters( 'croco-mki/export/options-to-export', array(
				'blogname',
				'blogdescription',
				'users_can_register',
				'posts_per_page',
	...
	public function do_export( $into_file = true ) {
		...
		$use_custom_export = apply_filters( 'croco-mki/export/use-custom-export', false );
	...
	public function get_tables() {
		...
		$user_tables = apply_filters( 'croco-mki/export/tables-to-export', $user_tables );
	...
	private function get_widgets() {
		...
		$data = apply_filters( 'croco-mki/export/pre-get-widgets', $sidebars_widget_instances );

		// Encode the data for file contents
		$encoded_data = json_encode( $data );
		$encoded_data = apply_filters( 'croco-mki/export/get-widgets', $encoded_data );
