...
>
	...
	></div>
	<p><?php
		_e( 'Each landing comes with the custom demo content and a predefined set of plugins. Depending upon the selected landing the wizard will install the required plugins and some demo data.', 'croco-mki' );
	?></p>
	<cx-vui-tabs
		:invert="true"
		:in-panel="true"
