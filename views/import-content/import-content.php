<div class="cbw-import-content">
	<div class="cbw-body__title"><?php
		_e( 'Importing sample data', 'croco-mki' );
	?></div>
	<cbw-clear-content
	...
	<div class="cbw-import-summary">
		<table>
			<thead>
				<tr>
					<th class="summary-label"><?php _e( 'Import summary', 'croco-mki' ); ?></th>
					<th class="summary-progress"><?php _e( 'Progress', 'croco-mki' ); ?></th>
					<th class="summary-total"><?php _e( 'Complete', 'croco-mki' ); ?></th>
				</tr>
			</thead>
			<tbody>
				<tr
