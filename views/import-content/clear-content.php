<div class="cbw-clear-content">
	...
	<div class="cbw-clear-content__message">
		<?php
			_e( 'Please, enter your WordPress user password to confirm and start content replacing.', 'croco-mki' );
		?>
	</div>
	<div class="cbw-clear-content__controls">
		<cx-vui-input
			type="password"
			placeholder="<?php esc_html_e( 'Please, enter your password', 'croco-mki' ); ?>"
			:prevent-wrap="true"
			v-model="password"
		...
		<cx-vui-button
			...
			@click="clearContent"
		>
			<span slot="label"><?php _e( 'Confirm', 'croco-mki' ); ?></span>
		</cx-vui-button>
	</div>
	<div class="cbw-clear-content__note" v-if="! message">
		...
		<?php _e( 'All your content will be replaced (posts, pages, comments, attachments and terms)', 'croco-mki' ); ?>
	</div>
	<div
		:class="{
